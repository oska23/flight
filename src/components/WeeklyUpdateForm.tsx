...
type WeeklyUpdateFormType = {
  imageDimensions?: string;
  smallImageDimensions?: string;
  mediumImageDimensions?: string;
};

const WeeklyUpdateForm: FunctionComponent<WeeklyUpdateFormType> = ({
  imageDimensions,
  smallImageDimensions,
  mediumImageDimensions,
}) => {
  return (
    <div className={styles.footerSection}>
      ...
      <footer className={styles.footer}>
        <div className={styles.fickleflightBio}>
          <img className={styles.logoIcon} alt="" src={smallImageDimensions} />
